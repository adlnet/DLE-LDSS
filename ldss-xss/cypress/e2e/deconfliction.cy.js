...
describe('deconflictionsection', () => {
    beforeEach(() => {
      cy.wait(2000)
      const url = "/admin/deconfliction_service"
    ...
    it('Navigate from /deconfliction_service to /deconfliction_service/deconfliction', () => {
    ...
    it('Navigate from /deconfliction_service to /deconfliction_service/deconfliction; View button', () => {

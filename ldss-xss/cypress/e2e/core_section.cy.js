...
// CCV Upstreams
    it('Navigate from /admin to /core/ccvupstream', () => {
    ...
    it('Navigate from /admin to /core/ccvupstream/add; Add button', () => {
      // Navigate to /core/ccvupstream/add via '+ Add' button
      cy.get('#container #main #content-start #content #content-main .app-core table')
    ...
    it('Navigate from /admin to /core/ccvupstream; Change button', () => {
...
// LCV Downstreams
    it('Navigate from /admin to /core/lcvdownstream', () => {
    ...
    it('Navigate from /admin to /core/lcvdownstream/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/lcvdownstream; Change button', () => {
...
// Neo Alias
    it('Navigate from /admin to /core/neoalias', () => {
    ...
    it('Navigate from /admin to /core/neoalias/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/neoalias; Change button', () => {
...
// Neo Contexts
    it('Navigate from /admin to /core/neocontext', () => {
    ...
    it('Navigate from /admin to /core/neocontext/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/neocontext; Change button', () => {
...
// Neo definitions
    it('Navigate from /admin to /core/neodefinition', () => {
    ...
    it('Navigate from /admin to /core/neodefinition/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/neodefinition; Change button', () => {
...
// Neo terms
    it('Navigate from /admin to /core/neoterm', () => {
    ...
    it('Navigate from /admin to /core/neoterm/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/neoterm; Change button', () => {
...
//Search
    it('Navigate from /admin to /core/search', () => {
    ...
    it('Navigate from /admin to /core/search/add; Add button', () => {
    ...
    it('Navigate from /admin to /core/search; Change button', () => {

# Generated by Django 4.2.18 on 2025-01-23 12:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0007_search_alter_term_mapping'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('metadata_experiences', models.ManyToManyField(blank=True, related_name='ccv_source', to='core.metadataledger')),
                ('supplemental_experiences', models.ManyToManyField(blank=True, related_name='ccv_source', to='core.supplementalledger')),
            ],
        ),
        migrations.CreateModel(
            name='CCVDownstream',
            fields=[
                ...
                ('composite_experiences', models.ManyToManyField(blank=True, related_name='ccv_destination', to='core.compositeledger')),
                ('filter_metadata', models.ManyToManyField(blank=True, related_name='ccv_downstream', to='core.filtermetadata')),
                ('filter_records', models.ManyToManyField(blank=True, related_name='ccv_downstream', to='core.filterrecord')),
            ],
        ),
    ]
